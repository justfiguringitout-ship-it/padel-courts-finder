            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="bg-white border border-stone-200 rounded-lg p-5">
                  ...
                  <p className="text-stone-600 text-sm leading-relaxed">A round-shape beginner racket like the <a href="https://www.amazon.com/dp/B0BBPZLRVP?tag=padel02-20" target="_blank" rel="noopener noreferrer" className="text-emerald-600 hover:underline">Babolat Contact</a> ($90) plus a can of balls and an overgrip &mdash; total ~$130. That covers everything she needs for her first session. See our full <Link href="/blog/best-padel-rackets-beginners" className="text-emerald-600 hover:underline">beginner racket guide</Link> for more options.</p>
                </div>
                <div className="bg-white border border-stone-200 rounded-lg p-5">
