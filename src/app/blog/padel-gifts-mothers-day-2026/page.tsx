            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                ...
                <div className="bg-white border border-stone-200 rounded-xl p-5 sm:p-6">
                  ...
                  <p className="text-stone-600 text-sm leading-relaxed mb-3">
                    The <Link href="/blog/best-padel-rackets-beginners" className="text-padel-green hover:underline">best beginner racket on the market</Link>. 340g, huge sweet spot, gentle on arms. If she&apos;s just starting padel, this is the one &mdash; our #1 pick in our beginner racket guide.
                  </p>
      ...
      <div className="grain bg-court">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid sm:grid-cols-3 gap-4">
            ...
            <Link href="/blog/best-padel-rackets-beginners" className="block border border-stone-700 rounded-lg p-4 hover:border-padel-green/50 transition-colors">
