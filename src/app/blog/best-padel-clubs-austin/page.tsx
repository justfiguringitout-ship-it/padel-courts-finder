    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-white">
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mt-12 mb-12">
          <h2 className="text-3xl font-bold text-stone-900 mb-6">Coming Soon to Austin</h2>
          <p className="text-stone-700 text-lg leading-relaxed mb-6">
          ...
          <div className="space-y-6">
            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-6">
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-2">Padel39 East Austin</h3>
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-6">
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-2">The Padel Collective</h3>
              <p className="text-stone-700 mb-3">
            ...
            <div className="bg-amber-50 border-2 border-amber-200 rounded-xl p-6">
              ...
              <h3 className="text-2xl font-bold text-stone-900 mb-2">Padel Society</h3>
              <p className="text-stone-700 mb-3">
        ...
        <div className="mt-12">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Link href="/blog/best-padel-clubs-houston" className="bg-white border rounded-lg p-4 hover:shadow-lg transition-shadow">
              ...
              <p className="text-sm text-stone-600">Space City&apos;s padel courts</p>
            </Link>
