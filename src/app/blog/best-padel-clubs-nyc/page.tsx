...
export default function NYCBestClubsPage() {
  const articleData = {
    ...
    "@type": "Article",
    "headline": "Best Padel Clubs in nyc (2025) | Complete Guide & Rankings",
    "description": "Discover the best padel clubs in nyc. Complete guide with rankings, pricing, programs, and insider tips.",
    ...
    "mainEntityOfPage": {
      "@type": "WebPage",
      "@id": "https://padelcourtsfinder.com/blog/best-padel-clubs-nyc"
    }
  };
