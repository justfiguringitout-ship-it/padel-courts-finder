...
export default function CharlotteBestClubsPage() {
  const articleData = {
    ...
    "@type": "Article",
    "headline": "Best Padel Clubs in charlotte (2025) | Complete Guide & Rankings",
    "description": "Discover the best padel clubs in charlotte. Complete guide with rankings, pricing, programs, and insider tips.",
