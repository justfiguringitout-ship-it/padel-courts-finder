...
export default function SanDiegoBestClubsPage() {
  const articleData = {
    ...
    "@type": "Article",
    "headline": "Best Padel Clubs in san diego (2025) | Complete Guide & Rankings",
    "description": "Discover the best padel clubs in san diego. Complete guide with rankings, pricing, programs, and insider tips.",
