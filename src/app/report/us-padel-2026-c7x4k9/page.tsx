...
/**
 * PRIVATE full report — delivered by email gate on /state-of-us-padel-2026.
 * Unguessable slug, noindexed, and deliberately NOT in the sitemap: the
 * deep analysis lives here so it can't be scraped straight off the public
 * page. Keep the slug in sync with ReportGate.tsx.
 */
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <header className="grain bg-court text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
          <p className="font-mono text-sm text-turf mb-4">full report · reader edition · updated {updated}</p>
          <h1 className="font-display text-4xl md:text-6xl font-bold tracking-tight mb-6">
            The State of US Padel, 2026
          </h1>
          <p className="text-lg text-white/60 max-w-2xl mb-10">
            The complete dataset behind the American padel boom. This edition was sent to
            you personally — quote any figure with attribution
            (&quot;Source: Padel Courts Finder, State of US Padel 2026&quot;), but please
            don&apos;t republish the report wholesale.
          </p>
        ...
        <section id="cite" className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14 scroll-mt-24">
          <div className="grain relative bg-court text-white rounded-3xl overflow-hidden">
            <div className="relative px-6 py-12 md:px-12">
              ...
              <p className="text-white/60 leading-relaxed mb-4 max-w-3xl">
                You&apos;re welcome to cite any figure with attribution and a link:{" "}
                <span className="text-white">&quot;Source: Padel Courts Finder, State of US
                Padel 2026&quot;</span>. This reader edition is delivered by email — please
                share the public page (padelcourtsfinder.com/state-of-us-padel-2026) rather
                than this link, and don&apos;t republish the report wholesale. Global figures
                come from Playtomic&apos;s Global Padel Report 2026 and US Padel Association
                projections, credited inline.
              </p>
              <p className="text-white/60 leading-relaxed mb-8 max-w-3xl">
                <span className="text-white font-semibold">Media:</span> for custom cuts of
                the data, quotes, interviews, or the full dataset, get in touch — we
                typically turn press requests around same-day.
              </p>
              <Link
