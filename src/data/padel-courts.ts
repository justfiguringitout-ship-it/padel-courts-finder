...
export const courtsByState = padelCourts.reduce((acc, court) => {
  ...
  },
  {
    ...
    description: "Olympus Padel is Colorado Springs' first padel club, offering a social and inclusive environment for the world's fastest-growing racket sport. Located at The Farm, the facility features three indoor courts with high ceilings and is designed for players of all levels.",
    numberOfCourts: 3,
    courtType: "indoor",
    amenities: [
      "beginner clinics",
    ...
    rentalAvailable: true,
    socialArea: true,
    pricingText: "$5/person/hour weekdays; $10/person/hour weekends",
    status: "open",
    featured: false,
  },
  {
  ...
  },
  {
    ...
    zipCode: "",
    phone: "(512) 829-4340",
    website: "https://cliffdrysdale.com/austin-texas",
    rating: 4.3,
    reviewCount: 88,
    openingHours: {
      monday: "8:00am-9:00pm",
    ...
    description: "Dripping Springs Racquet Club, formerly known as Polo Tennis Club, is a premier state-of-the-art facility that serves as a hub for racquet sports and social life in southwest Austin. It is the only facility in Austin to feature tennis, pickleball, and padel all in one location, with an 8,500 square foot clubhouse and resort-style amenities.",
    numberOfCourts: 3,
    courtType: "outdoor",
    amenities: [
      "lessons",
    ...
    coordinates: { lat: 30.2672, lng: -97.7431 }, // coordinates estimated
    instagram: "dsracquetclub",
    facebook: "https://www.facebook.com/dsracquetclub",
    membersOnly: false,
    lessonsAvailable: true,
    rentalAvailable: true,
    socialArea: true,
    pricingText: "Pay to Play passes available; Full Membership approx. $221/month",
    status: "open",
    featured: false,
  },
  {
